...
/**
 * Created by Zeth32 on 07/06/2017.
 */
...
public class searchRecycleAdapter extends RecyclerView.Adapter<searchRecycleAdapter.ViewHolder>{
    ...
    public searchRecycleAdapter(ArrayList<Book> mItems){
        super();
        this.mItems = mItems;
    }

    @Override
    public searchRecycleAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, final int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.home_book_list, viewGroup, false);
        ViewHolder viewHolder = new searchRecycleAdapter.ViewHolder(v);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(searchRecycleAdapter.ViewHolder holder, int position) {
