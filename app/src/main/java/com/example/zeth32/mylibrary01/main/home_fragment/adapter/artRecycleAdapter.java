...
public class artRecycleAdapter extends RecyclerView.Adapter<artRecycleAdapter.ViewHolder>{


    ArrayList<Book> mItems;

    public artRecycleAdapter(){
        super();
        mItems = new ArrayList<>();
        for(int i = 0; i<Book.books.size(); i++){
            if(Book.books.get(i).getGenre().toLowerCase().equals("art".toLowerCase())){
